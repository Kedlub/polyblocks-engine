...
void initText2D(const char *texturePath, const char *outlineTexturePath, const char *boldTexturePath,
    ...
    // Initialize Shader
    Text2DShaderID = LoadShaders("shaders/TextShader.vert.glsl", "shaders/TextShader.frag.glsl");
...
void printText2D(const char *text, int x, int y, int size, bool outlined = false, bool bold = false) {
    ...
    glBindTexture(GL_TEXTURE_2D,
                  outlined && bold ? Text2DTextureIDBoldOutline : (outlined ? Text2DTextureIDOutline : (bold
                                                                                                        ? Text2DTextureIDBold
                                                                                                        : Text2DTextureID)));
