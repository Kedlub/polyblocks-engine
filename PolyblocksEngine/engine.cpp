...
int main() {
    ...
    if (!window) {
        cout
                << "[engine.cpp] Failed window initialization! If you're using laptop, make sure you run this on your dedicated graphics card!"
                << endl;
        exit(EXIT_FAILURE);
    }
    ...
    initText2D("textures/RobotoMono.dds", "textures/RobotoMonoOutline.dds", "textures/RobotoMonoBold.dds",
               "textures/RobotoMonoBoldOutline.dds");
